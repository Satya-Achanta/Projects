...
public class CommentedProperties extends java.util.Properties
{
     ...
     */
    public Vector lineData = new Vector( 0,
                                         1 );
     ...
     * property.
     */
    public Vector keyData  = new Vector( 0,
                                         1 );
        ...
        for ( int i = 0; i < lineData.size(); i++ )
        {
            ...
            { // This is a 'property' line, so rebuild it
                formatForOutput( key,
                                 ...
                                 true );
                s.append( '=' );
                formatForOutput( (String) get( key ),
                                 s,
                                 false );
                writer.println( s );
            }
     ...
     *            formatted
     */
    private void formatForOutput( String str,
                                  StringBuffer buffer,
                                  boolean key )
    {
        if ( key )
     ...
     * CommentedProperties.
     * 
     * @param line The string to add to the end, make sure this is a comment or
     *            a 'whitespace' line.
     */
